;; 1. Based on: 7104RG
;; 2. Description: PQ new; hill ICU+d, Hosp BA2, Hosp leveln(incl ID 12+17), ICU(50%)+Vent BA45
;; x1. Author: dings
...
(0, 0.866,2) FIX ;39 F_Hosp
(0, 1.07,2) FIX ;40 F_Hosp
(0, 0.895,2) FIX ;41 F_Hosp
(-0.9, -0.493,0) FIX ;42 F_ICU_Omicron
(0) FIX ;43 F_LD_Omicron
(-0.9, -0.302,0) FIX ;44 F_Vent_Omicron
(0, 0.309,1) FIX ; 45 F_LD_ICU_Om
(600, 783,830) FIX ;46 MT ICU
(0, 0.711,1) FIX ;47 F_ICU2022
(0, 0.575,1) FIX ;48 F_Death2022
(0) FIX ;49 F_Hosp2022
(0, 9.22,50) FIX ;50 hill_2022
(-1, 0,10) FIX ;51 F_Hosp_BA45 Zugewinn Hospitalisierungsrate durch BA4/5 
(-1, 0.5,10) FIX ;52 F_ICU_BA45 Zugewinn ICUrate durch BA4/5 
(-1, 0,10) FIX ;53 F_Death_BA45 Zugewinn Sterberate durch BA4/5 
(-1, -0.291,0) FIX ;54 F_Hosp_BA2 Zugewinn Hospitalisierungsrate durch BA2 
(790, 822) FIX ;55 MT Hosp
(-1, -0.338,10) FIX ;56 F_Vent_BA45
...
$EST METHOD=1 INTER MAXEVAL=99999 NOABORT NSIG=2 SIGL=6 PRINT=1 POSTHOC
...
$TABLE ID TIME DV OBS CMT EVID MDV IPRED Rt R0FREE R0FREE_OLD hosp_TV hospfactor hosp FRACTHOSP FRACTICU KHd ICUd BEATd OUTd KHd80 death ONEHEADER NOPRINT FILE=sdtab7104R
