...
$DATA ..\DATASET\COVID_ds_226_Impf_VOC_Betten_V2_R0_9000_40.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
(600, 795,830) ;46 MT ICU
(0, 0.82,1) ;47 F_ICU2022
(0, 0.581,1) ;48 F_Death2022
(0, 0.316,1) ;49 F_Hosp2022
(0, 7.65,50) ;50 hill_2022
...
$TABLE ID TIME DV OBS CMT EVID MDV IPRED Rt R0FREE R0FREE_OLD hosp_TV hospfactor hosp FRACTHOSP FRACTICU KHd ICUd BEATd OUTd KHd80 death ONEHEADER NOPRINT FILE=sdtab9100R
