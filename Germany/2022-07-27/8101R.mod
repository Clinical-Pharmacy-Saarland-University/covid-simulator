...
$DATA ..\DATASET\COVID_ds_234_Impf_VOC_Betten_V2_R0_8000_41.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
(600, 783,830) ;46 MT ICU
(0, 0.713,1) ;47 F_ICU2022
(0, 0.578,1) ;48 F_Death2022
(0) FIX ;49 F_Hosp2022
(0, 9.39,50) ;50 hill_2022
...
(-1, -0.283,0) ;54 F_Hosp_BA2 Zugewinn Hospitalisierungsrate durch BA2 
(790, 822) ;55 MT Hosp
(-1, -0.322,10) ;56 F_Vent_BA45
...
$TABLE ID TIME DV OBS CMT EVID MDV IPRED Rt R0FREE R0FREE_OLD hosp_TV hospfactor hosp FRACTHOSP FRACTICU KHd ICUd BEATd OUTd KHd80 death ONEHEADER NOPRINT FILE=sdtab8101R
