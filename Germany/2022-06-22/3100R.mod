...
$DATA ..\DATASET\COVID_ds_229_Impf_VOC_Betten_V2_R0_3000_41.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
(600, 790,830) ;46 MT ICU
(0, 0.755,1) ;47 F_ICU2022
(0, 0.528,1) ;48 F_Death2022
(0, 0.302,1) ;49 F_Hosp2022
(0, 9.05,50) ;50 hill_2022
