...
$DATA ..\DATASET\COVID_ds_237_Impf_VOC_Betten_V2_R0_2004_42.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
(0, 0.744,1) ;47 F_ICU2022
(0, 0.603,1) ;48 F_Death2022
(0) FIX ;49 F_Hosp2022
(0, 7.9,50) ;50 hill_2022
(-1, 0.244,10) ;51 F_Hosp_BA45 Zugewinn Hospitalisierungsrate durch BA4/5 
(-1, 0.579,10) ;52 F_ICU_BA45 Zugewinn ICUrate durch BA4/5 
(-1, 0,10) FIX ;53 F_Death_BA45 Zugewinn Sterberate durch BA4/5 
(-1, -0.321,0) ;54 F_Hosp_BA2 Zugewinn Hospitalisierungsrate durch BA2 
(790, 823) FIX ;55 MT Hosp
(-1, -0.341,10) ;56 F_Vent_BA45
