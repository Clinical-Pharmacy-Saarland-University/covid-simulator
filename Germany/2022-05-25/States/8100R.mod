...
$DATA ..\DATASET\COVID_ds_225_Impf_VOC_Betten_V2_R0_8000_40.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
(600, 797,830) ;46 MT ICU
(0, 0.842,1) ;47 F_ICU2022
(0, 0.588,1) ;48 F_Death2022
(0, 0.327,1) ;49 F_Hosp2022
(0, 7.34,50) ;50 hill_2022
...
$TABLE ID TIME DV OBS CMT EVID MDV IPRED Rt R0FREE R0FREE_OLD hosp_TV hospfactor hosp FRACTHOSP FRACTICU KHd ICUd BEATd OUTd KHd80 death ONEHEADER NOPRINT FILE=sdtab8100R
