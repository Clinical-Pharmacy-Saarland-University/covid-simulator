...
$DATA ..\DATASET\COVID_ds_224_Impf_VOC_Betten_V2_R0_7000_40.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
R0FREE = R0FREE_OLD*((1-(Alpha-Delta*0.92/0.99)-Delta)+1.35*(Alpha-Delta*0.92/0.99) + FaktorDelta*(Delta-Omicron) + FaktorOmicron*Omicron*(1-BA2) + FaktorBA2*Omicron*BA2)
beta = R0FREE*gamma
...
R0 = R0FREE_OLD*(1-(Alpha_Err-Delta_Err*0.92/0.99)-Delta_Err)+R0FREE_OLD*1.35*(Alpha_Err-Delta_Err*0.92/0.99) + R0FREE_OLD*FaktorDelta*(Delta_Err-Omicron_Err) + R0FREE_OLD*FaktorOmicron*Omicron_Err*(1-BA2_Err) + R0FREE_OLD*FaktorBA2*Omicron_Err*BA2_Err
SUSCEPTIBLES = A(1)
...
(600, 798,830) ;46 MT ICU
(0, 0.854,1) ;47 F_ICU2022
(0, 0.637,1) ;48 F_Death2022
(0, 0.318,1) ;49 F_Hosp2022
(0, 7.18,50) ;50 hill_2022
...
$TABLE ID TIME DV OBS CMT EVID MDV IPRED Rt R0FREE R0FREE_OLD hosp_TV hospfactor hosp FRACTHOSP FRACTICU KHd ICUd BEATd OUTd KHd80 death ONEHEADER NOPRINT FILE=sdtab7100R
