;; 1. Based on: 1101
;; 2. Description: 25Rt+M,  M1 h+ICU+d, M2 h+B, M3 h+d+I, M4 h+I+d, M5 h+d+I, M6 h+d, M7 h nach Weihnachten, MT8 d+I+h, MT9 d+h+I
;; x1. Author: dings
;; 3. Label:
...
$INPUT ID TIME TIME2 DROP DV LNDV LNDVCR OBS CMT AMT EVID MDV STATE=DROP NUMBER CASE0 ICUDATASET DIVIFLAG SCHOOLS STORECLOSURE CURFEW RESTRAININGORDER CARNIVAL FLAGZEROOBS FLAGRKI FLAGMP DOSING2 MAXIMUMICU FLAG20200714 MDV20200714 FLAG20200804 RKIDEATHS MPCASES MPCASESRECOVRKIDEATH fixR0_0 fixR0_1 fixR0_2 fixR0_3 fixR0_4 fixR0_5 fixR0_6 fixR0_7 fixR0_8 fixR0_9 fixR0_10 fixR0_11 fixR0_12 fixR0_13 fixR0_14 fixR0_15 fixR0_16 fixR0_17 fixR0_18 fixR0_19 fixR0_20 fixR0_21 fixR0_22 fixR0_23 fixR0_24 fixR0_25 fixR0_26 fixR0_27 fixCP_4 fixCP_5 fixCP_6 fixCP_7 fixCP_8 fixCP_9 fixCP_10 fixCP_11 fixCP_12 fixCP_13 fixCP_14 fixCP_15 fixCP_16 fixCP_17 fixCP_18 fixCP_19 fixCP_20 fixCP_21 fixCP_22 fixCP_23 fixCP_24 fixCP_25 fixCP_26 fixCP_27 fixF2 fixIIV1 fixIIV2 fixIIV3 fixIIV4 fixIIV5 fixIIV6 fixIIV7 fixIIV8 fixIIV9 fixIIV10 fixIIV11 fixIIV12 fixIIV13 fixIIV14 fixIIV15 fixIIV16 fixIIV17 fixIIV18 fixIIV19 fixIIV20 fixIIV21 fixIIV22 fixIIV23 fixIIV24 fixIIV25 fixIIV26 fixIIV27 fixIIV28 fixIIV29 fixIIV30 fixIIV31 PREDIC MDVLAST
$DATA ..\DATASET\COVID_ds_159_runC1008a_run1101.csv IGNORE=@ IGNORE(DOSING2.EQ.1) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.9) IGNORE(CMT.EQ.12) IGNORE(DIVIFLAG.EQ.2) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(ID.EQ.17) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
FKH9 = THETA(36)*EXP(IIV30)
FICU6 = EXP(LOG(THETA(37)/(1-THETA(37)))+IIV31)/(1+EXP(LOG(THETA(37)/(1-THETA(37)))+IIV31)) 

hosptrans = THETA(1)*EXP((IIV1))
hosp = THETA(2)*EXP((IIV2))*(1-MPAST(6))+FKH*(MPAST(6)-MPAST(10))+FKH2*(MPAST(10)-MPAST(14))+FKH3*(MPAST(14)-MPAST(18))+FKH4*(MPAST(18)-MPAST(20))+FKH5*(MPAST(20)-MPAST(23))+FKH6*(MPAST(23)-MPAST(27))+FKH7*(MPAST(27)-MPAST(30))+FKH8*(MPAST(30)-MPAST(32))+FKH9*MPAST(32)
isolated = (1-hosp)*isolation
hospitalized = hosp*isolation

; FRACTION TO STANDARD CARE
FRACTHOSP = P_KH*EXP((IIV3))*(1-MPAST(6))+FICU*(MPAST(6)-MPAST(14))+FICU2*(MPAST(14)-MPAST(18))+FICU3*(MPAST(18)-MPAST(20))+FICU4*(MPAST(20)-MPAST(30))+FICU5*(MPAST(30)-MPAST(32))+FICU6*MPAST(32)
...
(5, 22.1) FIX ;30 MT7
(0.1, 0.348,1.5) FIX ;31 D6
(0.05, 0.807,1) FIX ;32 ICU5
(0.01, 0.0168,0.4) FIX ;33 KH8
(5, 31.5) FIX;34 MT8
(0.1, 0.454,1.5) FIX;35 D7
(0.001, 0.018,0.4) FIX ;36 KH9
(0.05, 0.977,1) FIX ;37 ICU6
...
$TABLE ID TIME TIME2 DV OBS CMT EVID MDV IPRED IIV1 IIV2 IIV3 IIV4 IIV5 IIV6 IIV7 IIV8 IIV9 IIV10 IIV11 IIV12 IIV13 IIV14 IIV15 IIV16 IIV17 IIV18 IIV19 IIV20 IIV21 IIV22 IIV23 IIV24 IIV25 IIV26 IIV27 IIV28 IIV29 IIV30 IIV31 F2 R0_0 R0_1 R0_2 R0_3 R0_4 R0_5 R0_6 R0_7 R0_8 R0_9 R0_10 R0_11 R0_12 R0_13 R0_14 R0_15 R0_16 R0_17 R0_18 R0_19 R0_20 R0_21 R0_22 R0_23 R0_24 R0_25 R0_26 R0_27 CP_4 CP_5 CP_6 CP_7 CP_8 CP_9 CP_10 CP_11 CP_12 CP_13 CP_14 CP_15 CP_16 CP_17 CP_18 CP_19 CP_20 CP_21 CP_22 CP_23 CP_24 CP_25 CP_26 CP_27 R0FREE R0FREE_OLD hosp FRACTHOSP FRACTICU KHd ICUd BEATd death LDdeathKH LDdeathICU LDdeathBEAT LDrecoveryKH LDrecoveryICU LDrecoveryBEAT ONEHEADER NOPRINT FILE=sdtab1101R
