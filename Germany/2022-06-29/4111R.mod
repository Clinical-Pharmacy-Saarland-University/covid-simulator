;; 1. Based on: 4111
;; 2. Description: PQ new; hill ICU+d+hosp, Hosp BA2, Hosp leveln
;; x1. Author: user
...
$DATA ..\DATASET\COVID_ds_230_Impf_VOC_Betten_V2_R0_4000_41.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
StarttagBA4_5 = 347+501
kBA4_5= 0.125
initBA4_5= 0.002
FaktorBA4_5 = 1.97*1.62*1.5*1.79     ;Factor BA4_5 vs WT
...
(600, 782,830) ;46 MT ICU
(0, 0.695,1) ;47 F_ICU2022
(0, 0.556,1) ;48 F_Death2022
0 FIX  ;49 F_Hosp2022
(0, 8.92,50) ;50 hill_2022
...
(-1, -0.337,0) ;54 F_Hosp_BA2 Zugewinn Hospitalisierungsrate durch BA2 
(790, 822) ;46 MT Hosp
...
$TABLE ID TIME DV OBS CMT EVID MDV IPRED Rt R0FREE R0FREE_OLD hosp_TV hospfactor hosp FRACTHOSP FRACTICU KHd ICUd BEATd OUTd KHd80 death ONEHEADER NOPRINT FILE=sdtab4111R
