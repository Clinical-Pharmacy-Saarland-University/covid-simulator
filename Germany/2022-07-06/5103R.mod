;; 1. Based on: 5103RG
;; 2. Description: PQ new; hill ICU+d, Hosp BA2, Hosp leveln(incl ID 12+17)
;; x1. Author: user
...
$DATA ..\DATASET\COVID_ds_231_Impf_VOC_Betten_V2_R0_5004_41.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
(600, 781,830) FIX ;46 MT ICU
(0, 0.678,1) FIX ;47 F_ICU2022
(0, 0.552,1) FIX ;48 F_Death2022
(0) FIX ;49 F_Hosp2022
(0, 10.1,50) FIX ;50 hill_2022
...
(-1, -0.306,0) FIX ;54 F_Hosp_BA2 Zugewinn Hospitalisierungsrate durch BA2 
(790, 822) FIX ;46 MT Hosp
...
$TABLE ID TIME DV OBS CMT EVID MDV IPRED Rt R0FREE R0FREE_OLD hosp_TV hospfactor hosp FRACTHOSP FRACTICU KHd ICUd BEATd OUTd KHd80 death ONEHEADER NOPRINT FILE=sdtab5103R
