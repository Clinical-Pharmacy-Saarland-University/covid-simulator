;; 1. Based on: 0010
;; 2. Description: 22Rt+M, dout, MT1 h+ICU+d, MT2 h+B, MT3 h+d+I, MT4 h+I+d, MT5 h+d+I(openIIV+params), MT6 h+d, MT7 h nach Weihnachten
;; x1. Author: dings
...
$INPUT ID TIME TIME2 DROP DV LNDV LNDVCR OBS CMT AMT EVID MDV STATE=DROP NUMBER CASE0 ICUDATASET DIVIFLAG SCHOOLS STORECLOSURE CURFEW RESTRAININGORDER CARNIVAL FLAGZEROOBS FLAGRKI FLAGMP DOSING2 MAXIMUMICU FLAG20200714 MDV20200714 FLAG20200804 RKIDEATHS MPCASES MPCASESRECOVRKIDEATH fixR0_0 fixR0_1 fixR0_2 fixR0_3 fixR0_4 fixR0_5 fixR0_6 fixR0_7 fixR0_8 fixR0_9 fixR0_10 fixR0_11 fixR0_12 fixR0_13 fixR0_14 fixR0_15 fixR0_16 fixR0_17 fixR0_18 fixR0_19 fixR0_20 fixR0_21 fixR0_22 fixR0_23 fixR0_24 fixCP_4 fixCP_5 fixCP_6 fixCP_7 fixCP_8 fixCP_9 fixCP_10 fixCP_11 fixCP_12 fixCP_13 fixCP_14 fixCP_15 fixCP_16 fixCP_17 fixCP_18 fixCP_19 fixCP_20 fixCP_21 fixCP_22 fixCP_23 fixCP_24 fixF2 fixIIV1 fixIIV2 fixIIV3 fixIIV4 fixIIV5 fixIIV6 fixIIV7 fixIIV8 fixIIV9 fixIIV10 fixIIV11 fixIIV12 fixIIV13 fixIIV14 fixIIV15 fixIIV16 fixIIV17 fixIIV18 fixIIV19 fixIIV20 fixIIV21 fixIIV22 fixIIV23 fixIIV24 fixIIV25 PREDIC MDVLAST
$DATA ..\DATASET\COVID_ds_140_runC0008b_run0010.csv IGNORE=@ IGNORE(DOSING2.EQ.1) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.9) IGNORE(CMT.EQ.12) IGNORE(DIVIFLAG.EQ.2) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(ID.EQ.17) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
;;;;Metakis-Information;;;;;
P_KH = 0.81
P_ICU = 0.309 ;Prozent ICU vs BEAT
...
P_BEAT_AUFENTHALT_D = 0.73;Beatmung % Aufenthalt verstorben
P_BEAT_AUFENTHALT_L = 0.35;Beatmung % Aufenthalt entlassen
P_BEAT_on_ICU_AUFENTHALT_D = 0.74;beatmet ICU % Aufenthalt verstorben
P_BEAT_on_ICU_AUFENTHALT_L =  0.5;beatmet ICU % Aufenthalt entlassen
P_ICU_AUFENTHALT_D = 0.42;unbeatmet ICU % Aufenthalt verstorben
P_ICU_AUFENTHALT_L = 0.3;unbeatmet ICU % Aufenthalt entlassen
...
R0FREE_OLD = R0START*(1-COV1)+E2*COV2+E1*(COV1-COV3)+E3*(COV3-COV4)+E4*(COV4-COV5)+E5*(COV5-COV6)+E6*(COV6-COV7)+E7*(COV7-COV8)+E8*(COV8-COV9)+E9*(COV9-COV10)+E10*(COV10-COV11)+E11*(COV11-COV12)+E12*(COV12-COV13)+E13*(COV13-COV14)+E14*(COV14-COV15)+E15*(COV15-COV16)+E16*(COV16-COV17)+E17*(COV17-COV18)+E18*(COV18-COV19)+E19*(COV19-COV20)+E20*(COV20-COV21)+E21*(COV21-COV22)+E22*(COV22-COV23)+E23*COV23+E24*COV24
R0BASE = R0START
R0END = E22
...
hosp = THETA(2)*EXP((IIV2))*(1-MPAST(6))+FKH*(MPAST(6)-MPAST(10))+FKH2*(MPAST(10)-MPAST(14))+FKH3*(MPAST(14)-MPAST(18))+FKH4*(MPAST(18)-MPAST(20))+FKH5*(MPAST(20)-MPAST(23))+FKH6*(MPAST(23)-MPAST(27))+FKH7*MPAST(27)
isolated = (1-hosp)*isolation
hospitalized = hosp*isolation

; FRACTION TO STANDARD CARE
FRACTHOSP = P_KH*EXP((IIV3))*(1-MPAST(6))+FICU*(MPAST(6)-MPAST(14))+FICU2*(MPAST(14)-MPAST(18))+FICU3*(MPAST(18)-MPAST(20))+FICU4*MPAST(20)
...
KHd = P_KH_D*EXP(IIV5)*FD**MPAST(6)*(FD2**MPAST(14))*(FD3**MPAST(18))*(FD4**MPAST(20))*(FD5**MPAST(23))
ICUd =  P_ICU_D*EXP(IIV5)*FD**MPAST(6)*(FD2**MPAST(14))*(FD3**MPAST(18))*(FD4**MPAST(20))*(FD5**MPAST(23))
BEATd = P_BEAT_D*EXP(IIV5)*FD**MPAST(6)*(FD2**MPAST(14))*(FD3**MPAST(18))*(FD4**MPAST(20))*(FD5**MPAST(23))
death = 0.0119*EXP(IIV5)*FD**MPAST(6)*(FD2**MPAST(14))*(FD3**MPAST(18))*(FD4**MPAST(20))*(FD5**MPAST(23))
IF(KHd.GT.1) KHd=1
IF(ICUd.GT.1) ICUd=1
IF(BEATd.GT.1) BEATd=1
IF(death.GT.1) BEATd=1
IF(KHd.LT.0) KHd=0
IF(ICUd.LT.0) ICUd=0
...
(367) FIX ;25 MT6
(0.01, 0.0862,0.4) FIX;26 KH6
(0.1, 1.18,1.5) FIX;27 D6
(13) FIX ;28 MT7
(0.01, 0.0301,0.4)FIX ;29 KH7
...
$TABLE ID TIME TIME2 DV OBS CMT EVID MDV IPRED IIV1 IIV2 IIV3 IIV4 IIV5 IIV6 IIV7 IIV8 IIV9 IIV10 IIV11 IIV12 IIV13 IIV14 IIV15 IIV16 IIV17 IIV18 IIV19 IIV20 IIV21 IIV22 IIV23 IIV24 IIV25 F2 R0_0 R0_1 R0_2 R0_3 R0_4 R0_5 R0_6 R0_7 R0_8 R0_9 R0_10 R0_11 R0_12 R0_13 R0_14 R0_15 R0_16 R0_17 R0_18 R0_19 R0_20 R0_21 R0_22 R0_23 R0_24 CP_4 CP_5 CP_6 CP_7 CP_8 CP_9 CP_10 CP_11 CP_12 CP_13 CP_14 CP_15 CP_16 CP_17 CP_18 CP_19 CP_20 CP_21 CP_22 CP_23 CP_24 R0FREE hosp FRACTHOSP FRACTICU KHd ICUd BEATd death LDdeathKH LDdeathICU LDdeathBEAT LDrecoveryKH LDrecoveryICU LDrecoveryBEAT ONEHEADER NOPRINT FILE=sdtab0010R
