;; 1. Based on: 0042
;; 2. Description: FIX RKI Modell (Ges.Dtl), open IIVs, 23 Effects RKI, Mutante
;; x1. Author: dings
...
$INPUT ID TIME DROP Landkreis=DROP IdLandkreis Bundesland=DROP ID_BL DV AMT MDV CMT Week OBS EWZ DV_CASE0 SCHOOLS STORECLOSURE CURFEW RESTRAININGORDER CARNIVAL day=DROP MDVWKND=DROP fixR0_0 fixR0_1 fixR0_2 fixR0_3 fixR0_4 fixR0_5 fixR0_6 fixR0_7 fixR0_8 fixR0_9 fixR0_10 fixR0_11 fixR0_12 fixR0_13 fixR0_14 fixR0_15 fixR0_16 fixR0_17 fixR0_18 fixR0_19 fixR0_20 fixR0_21 fixCP_4 fixCP_5 fixCP_6 fixCP_7 fixCP_8 fixCP_9 fixCP_10 fixCP_11 fixCP_12 fixCP_13 fixCP_14 fixCP_15 fixCP_16 fixCP_17=DROP fixCP_18=DROP fixCP_19=DROP fixCP_20=DROP fixCP_21=DROP fixF2 PREDIC
$DATA ..\..\DATASET\Landkreise_V4_2021_02_24_R0_0041.csv IGNORE=@ IGNORE(PREDIC.EQ.1) IGNORE(CMT.GT.3)
...
MTIME(15) = MTIME(14)+THETA(1)
COV17 = MPAST(15)
E17 = THETA(2)*EXP(ETA(1))

MTIME(16) = MTIME(15)+THETA(3)
COV18 = MPAST(16)
E18 = THETA(4)*EXP(ETA(2))

MTIME(17) = MTIME(16)+THETA(5)
COV19 = MPAST(17)
E19 = THETA(6)*EXP(ETA(3))
...
(0, 10.1) FIX;7 +MTIME20
(0.5, 1.21) FIX;8 EFFECT20
(0, 10.5) FIX;9 +MTIME21
(0.5, 0.782) FIX;10 EFFECT21
(0, 9.77) FIX;11 +MTIME22
(0.5, 0.837) FIX;12 EFFECT22
(0, 11.8) FIX;11 +MTIME23
(0.5, 0.728) FIX;12 EFFECT23
(0, 9.5) FIX;11 +MTIME24
(0, 0.149) FIX;12 EFFECT24

$OMEGA 
 0.0232 FIX;1 EFFECT17
 0.004 FIX;2 EFFECT18
 0.0257 FIX;3 EFFECT19
 0.0065 FIX;4 EFFECT20
 0.0145 FIX;5 EFFECT21
 0.0281 FIX;6 EFFECT22
 0.0041 FIX;7 EFFECT23
 0 FIX;8 EFFECT24
