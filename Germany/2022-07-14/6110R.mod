...
$DATA ..\DATASET\COVID_ds_232_Impf_VOC_Betten_V2_R0_6001_41.csv IGNORE=@ IGNORE(ID.EQ.17) IGNORE(DOSING2.EQ.1) IGNORE(DIVIFLAG.EQ.2) IGNORE(CMT.EQ.8) IGNORE(CMT.EQ.11) IGNORE(CMT.EQ.12) IGNORE(CMT.EQ.9) IGNORE(FLAGZEROOBS.EQ.1) IGNORE(FLAGRKI.EQ.1) IGNORE(PREDIC.EQ.1)
...
(0, 0.713,1) FIX ;47 F_ICU2022
(0, 0.57,1) FIX ;48 F_Death2022
(0) FIX ;49 F_Hosp2022
(0, 8.98,50) FIX ;50 hill_2022
...
(-1, -0.299,0) FIX ;54 F_Hosp_BA2 Zugewinn Hospitalisierungsrate durch BA2 
(790, 822) FIX ;55 MT Hosp
(-1, -0.349,10) FIX ;56 F_Vent_BA45
...
$TABLE ID TIME DV OBS CMT EVID MDV IPRED Rt R0FREE R0FREE_OLD hosp_TV hospfactor hosp FRACTHOSP FRACTICU KHd ICUd BEATd OUTd KHd80 death ONEHEADER NOPRINT FILE=sdtab6110R
